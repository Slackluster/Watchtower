...
L.FLAG_TEMPLATE[4].description =         "Становится видимым, когда работает Ярмарка Новолуния и персонаж не выполнил квест «Выцветшая карта сокровищ» на 100 билетов Ярмарки Нovolуния."
L.FLAG_TEMPLATE[5] = {}
