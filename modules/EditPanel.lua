...
function app:CreateEditPanel()
	...
	local string3 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "Game13Font_o1")
	...
	local string7 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "Game13Font_o1")
	...
	local string12 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "Game13Font_o1")
	...
	local string14 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "Game13Font_o1")
	...
	app.EditPanel.Pages[11].Title:SetFontObject(Game12Font)
	...
	app.EditPanel.Pages[12].Title:SetFontObject(Game12Font)
	...
	app.EditPanel.Pages[12].Icon:SetFontObject(Game12Font)
	...
	app.EditPanel.Pages[12].Description:SetFontObject(Game12Font)
	...
	app.EditPanel.Pages[12].URL:SetFontObject(Game12Font)
	...
	app.EditPanel.Pages[12].Version:SetFontObject(Game12Font)
	...
	app.EditPanel.Pages[32].HideAfter:SetFontObject(Game12Font)
