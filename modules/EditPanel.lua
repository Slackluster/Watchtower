...
function app:CreateEditPanel()
	...
	app.EditPanel.Options.Icon.Search:SetHighlightTexture("interface/talentframe/talents")
	local hl = app.EditPanel.Options.Icon.Search:GetHighlightTexture()
	hl:SetBlendMode("BLEND")
	hl:SetTexCoord(0.392, 0.41, 0.215, 0.25)
	hl:SetAllPoints(app.EditPanel.Options.Icon.Search)
