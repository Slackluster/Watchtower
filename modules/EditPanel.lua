...
function app:CreateEditPanel()
	...
	local string1 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "SystemFont_Shadow_Outline_Large")
	string1:SetPoint("TOPLEFT", app.EditPanel.Pages[10], 10, -12)
	string1:SetText(L.TUTORIAL_HEADER)

	local string2 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	string2:SetJustifyH("LEFT")
	string2:SetPoint("TOPLEFT", string1, "BOTTOMLEFT", 3, -4)
	string2:SetText(L.TUTORIAL_EXPLAIN1 .. "\n" .. L.TUTORIAL_EXPLAIN2)

	local string3 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "SystemFont_Shadow_Med2_Outline")
	string3:SetPoint("TOPLEFT", string2, "BOTTOMLEFT", -3, -14)
	string3:SetText(L.TUTORIAL_TRIGGERE)

	local string4 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	string4:SetPoint("TOPLEFT", string3, "BOTTOMLEFT", 3, -4)
	string4:SetText(L.TUTORIAL_TRIGGER1)

	local string5 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	local string6 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	string6:SetPoint("TOPLEFT", string5, "BOTTOMLEFT", -10, -3)
	string6:SetText(L.TUTORIAL_TRIGGER2)

	local string7 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "SystemFont_Shadow_Med2_Outline")
	string7:SetPoint("TOPLEFT", string6, "BOTTOMLEFT", -3, -14)
	string7:SetText(L.TUTORIAL_VISIBILITY)

	local string8 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	string8:SetPoint("TOPLEFT", string7, "BOTTOMLEFT", 3, -4)
	string8:SetText(L.TUTORIAL_VISIBILITY1)

	local string9 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	local string10 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	string10:SetPoint("TOPLEFT", string9, "BOTTOMLEFT", -10, -3)
	string10:SetText(L.TUTORIAL_VISIBILITY2)

	local string11 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	local string12 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "SystemFont_Shadow_Med2_Outline")
	string12:SetPoint("TOPLEFT", string11, "BOTTOMLEFT", -13, -11)
	string12:SetText(L.TUTORIAL_TITLE)

	local string13 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	string13:SetPoint("TOPLEFT", string12, "BOTTOMLEFT", 3, -3)
	string13:SetText(L.TUTORIAL_TITLE1)

	local string14 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "SystemFont_Shadow_Med2_Outline")
	string14:SetPoint("TOPLEFT", string13, "BOTTOMLEFT", -3, -14)
	string14:SetText(L.TUTORIAL_WHAT)

	local string15 = app.EditPanel.Pages[10]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	string15:SetJustifyH("LEFT")
	string15:SetPoint("TOPLEFT", string14, "BOTTOMLEFT", 3, -4)
	string15:SetText(L.TUTORIAL_WHAT1)

	local button1 = app:MakeButton(app.EditPanel.Pages[10], L.TUTORIAL_GETFLAGS)
	...
	string1:SetPoint("TOPLEFT", app.EditPanel.Pages[11], 10, -16)

	app.EditPanel.Pages[11].TitleBackdrop = CreateFrame("Frame", nil, app.EditPanel.Pages[11], "BackdropTemplate")
	app.EditPanel.Pages[11].TitleBackdrop:SetSize(200, 23)
	app.EditPanel.Pages[11].TitleBackdrop:SetPoint("LEFT", string1, "LEFT", leftEdge, 0)
	app.EditPanel.Pages[11].TitleBackdrop:SetBackdrop({
		bgFile = "Interface/Tooltips/UI-Tooltip-Background",
		edgeFile = "Interface/Tooltips/UI-Tooltip-Border",
		edgeSize = 16,
		insets = { left = 4, right = 4, top = 4, bottom = 4 },
	})
	app.EditPanel.Pages[11].TitleBackdrop:SetBackdropColor(0.122, 0.122, 0.122, 0.8)

	app.EditPanel.Pages[11].Title = CreateFrame("EditBox", nil, app.EditPanel.Pages[11].TitleBackdrop)
	app.EditPanel.Pages[11].Title:SetFontObject(GameFontNormal)
	app.EditPanel.Pages[11].Title:SetTextColor(1, 1, 1)
	app.EditPanel.Pages[11].Title:SetSize(app.EditPanel.Pages[11].TitleBackdrop :GetWidth()-6, app.EditPanel.Pages[11].TitleBackdrop:GetHeight())
	app.EditPanel.Pages[11].Title:SetPoint("TOPLEFT", app.EditPanel.Pages[11].TitleBackdrop, 6, 0)
	app.EditPanel.Pages[11].Title:SetAutoFocus(false)
	app.EditPanel.Pages[11].Title:SetScript("OnEditFocusGained", function(self)
		self:HighlightText(0, 0)
	end)
	app.EditPanel.Pages[11].Title:SetScript("OnEnterPressed", function(self)
		self:ClearFocus()
	end)
	app.EditPanel.Pages[11].Title:SetScript("OnEscapePressed", function(self)
		self:SetText(app.FlagsList.Selected.title or "")
		self:ClearFocus()
	end)
	app.EditPanel.Pages[11].Title:SetScript("OnEditFocusLost", function(self)
		app.FlagsList.Selected.title = self:GetText()
		C_Timer.After(0.1, function() app:UpdateStatusList() end)
	end)

	local string2 = app.EditPanel.Pages[11]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	app.EditPanel.Pages[11].Style = CreateFrame("DropdownButton", nil, app.EditPanel.Pages[11], "WowStyle1DropdownTemplate")
	app.EditPanel.Pages[11].Style:SetDefaultText(L.GROUP_STYLE[1])
	app.EditPanel.Pages[11].Style:SetWidth(196)
	app.EditPanel.Pages[11].Style:SetPoint("LEFT", string2, leftEdge + 2, 0)
	local dropdown = app.EditPanel.Pages[11].Style
	app.EditPanel.Pages[11].Style:SetupMenu(function(dropdown, root)
	...
	local string3 = app.EditPanel.Pages[11]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	app.EditPanel.Pages[11].Anchor = CreateFrame("DropdownButton", nil, app.EditPanel.Pages[11], "WowStyle1DropdownTemplate")
	app.EditPanel.Pages[11].Anchor:SetDefaultText(L.GROUP_ANCHOR[1])
	app.EditPanel.Pages[11].Anchor:SetWidth(196)
	app.EditPanel.Pages[11].Anchor:SetPoint("LEFT", string3, leftEdge + 2, 0)
	local dropdown = app.EditPanel.Pages[11].Anchor
	app.EditPanel.Pages[11].Anchor:SetupMenu(function(dropdown, root)
	...
	local string4 = app.EditPanel.Pages[11]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	app.EditPanel.Pages[11].Font = CreateFrame("DropdownButton", nil, app.EditPanel.Pages[11], "WowStyle1DropdownTemplate")
	app.EditPanel.Pages[11].Font:SetWidth(196)
	app.EditPanel.Pages[11].Font:SetPoint("LEFT", string4, leftEdge + 2, 0)
	local dropdown = app.EditPanel.Pages[11].Font
	app.EditPanel.Pages[11].Font:SetupMenu(function(dropdown, root)
		for _, font in ipairs(app.Fonts) do
	...
	local string5 = app.EditPanel.Pages[11]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	app.EditPanel.Pages[11].Scale = CreateFrame("Frame", nil, app.EditPanel.Pages[11], "MinimalSliderWithSteppersTemplate")
	app.EditPanel.Pages[11].Scale:SetWidth(204)
	app.EditPanel.Pages[11].Scale:SetPoint("LEFT", string5, leftEdge - 2, -2)
	app.EditPanel.Pages[11].Scale:Init(100, options.minValue, options.maxValue, options.steps, options.formatters)
	app.EditPanel.Pages[11].Scale:RegisterCallback("OnValueChanged", function(self, value)
	...
	string1:SetText(L.TITLE)
	string1:SetPoint("TOPLEFT", app.EditPanel.Pages[12], 10, -12)
	...
	app.EditPanel.Pages[12].Title = CreateFrame("EditBox", nil, backdrop1)
	app.EditPanel.Pages[12].Title:SetFontObject(GameFontNormalMed1)
	app.EditPanel.Pages[12].Title:SetTextColor(1, 1, 1)
	app.EditPanel.Pages[12].Title:SetSize(backdrop1:GetWidth()-6, backdrop1:GetHeight())
	app.EditPanel.Pages[12].Title:SetPoint("TOPLEFT", backdrop1, 6, 0)
	app.EditPanel.Pages[12].Title:SetAutoFocus(false)
	app.EditPanel.Pages[12].Title:SetScript("OnEditFocusGained", function(self)
		self:HighlightText(0, 0)
	end)
	app.EditPanel.Pages[12].Title:SetScript("OnEnterPressed", function(self)
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].Title:SetScript("OnEscapePressed", function(self)
		self:SetText(app.FlagsList.Selected.title or "")
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].Title:SetScript("OnEditFocusLost", function(self)
		app.FlagsList.Selected.title = self:GetText()
		C_Timer.After(0.1, function() app:UpdateStatusList() end)
	end)

	local string2 = app.EditPanel.Pages[12]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	app.EditPanel.Pages[12].Icon = CreateFrame("EditBox", nil, backdrop2)
	app.EditPanel.Pages[12].Icon:SetFontObject(GameFontNormalMed1)
	app.EditPanel.Pages[12].Icon:SetTextColor(1, 1, 1)
	app.EditPanel.Pages[12].Icon:SetSize(backdrop2:GetWidth()-6, backdrop2:GetHeight())
	app.EditPanel.Pages[12].Icon:SetPoint("TOPLEFT", backdrop2, 6, 0)
	app.EditPanel.Pages[12].Icon:SetAutoFocus(false)
	app.EditPanel.Pages[12].Icon:SetScript("OnEditFocusGained", function(self)
		self:HighlightText(0, 0)
	end)
	app.EditPanel.Pages[12].Icon:SetScript("OnEnterPressed", function(self)
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].Icon:SetScript("OnEscapePressed", function(self)
		self:SetText(app.FlagsList.Selected.icon or "")
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].Icon:SetScript("OnEditFocusLost", function(self)
	...
	app.EditPanel.Pages[12].Icon.Search.Icon:SetAtlas("common-search-magnifyingglass")
	app.EditPanel.Pages[12].Icon.Search.Icon:SetAllPoints()
	app.EditPanel.Pages[12].Icon.Search:SetAlpha(0.5)
	app.EditPanel.Pages[12].Icon.Search:SetScript("OnEnter", function()
		app.EditPanel.Pages[12].Icon.Search:SetAlpha(1.0)
	end)
	app.EditPanel.Pages[12].Icon.Search:SetScript("OnLeave", function()
		app.EditPanel.Pages[12].Icon.Search:SetAlpha(0.5)
	end)
	app.EditPanel.Pages[12].Icon.Search:SetScript("OnClick", function()
		app.EditPanel.Pages[12].Icon.Search:SetAlpha(0.5)
	...
	local string3 = app.EditPanel.Pages[12]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	scrollFrame1:EnableMouse(true)
	scrollFrame1:SetScript("OnMouseDown", function()
		app.EditPanel.Pages[12].Trigger:SetFocus()
	end)
	...
	app.EditPanel.Pages[12].Trigger = CreateFrame("EditBox", nil, scrollFrame1)
	app.EditPanel.Pages[12].Trigger:SetFont("Interface\\AddOns\\Watchtower\\assets\\courbd.ttf", 14, "")
	app.EditPanel.Pages[12].Trigger:SetWidth(scrollFrame1:GetWidth())
	app.EditPanel.Pages[12].Trigger:SetHeight(scrollFrame1:GetHeight())
	app.EditPanel.Pages[12].Trigger:SetPoint("TOPLEFT")
	app.EditPanel.Pages[12].Trigger:SetMultiLine(true)
	app.EditPanel.Pages[12].Trigger:SetTextColor(0.612, 0.863, 0.996, 1)
	scrollFrame1:SetScrollChild(app.EditPanel.Pages[12].Trigger)

	app.EditPanel.Pages[12].Trigger:SetAutoFocus(false)
	app.EditPanel.Pages[12].Trigger:SetScript("OnEscapePressed", function(self)
	...
	app.EditPanel.Pages[12].Expand:SetDisabledTexture("RedButton-Expand-Disabled")
	...
	app.CodeBox:SetScript("OnShow", function()
		app.EditPanel.Pages[12].Expand:Hide()
	...
	local string4 = app.EditPanel.Pages[12]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	scrollFrame2:SetScript("OnMouseDown", function()
		app.EditPanel.Pages[12].Events:SetFocus()
	end)
	...
	app.EditPanel.Pages[12].Events = CreateFrame("EditBox", nil, scrollFrame2)
	app.EditPanel.Pages[12].Events:SetFont("Interface\\AddOns\\Watchtower\\assets\\courbd.ttf", 14, "")
	app.EditPanel.Pages[12].Events:SetWidth(scrollFrame2:GetWidth())
	app.EditPanel.Pages[12].Events:SetPoint("TOPLEFT")
	app.EditPanel.Pages[12].Events:SetMultiLine(true)
	app.EditPanel.Pages[12].Events:SetTextColor(0.612, 0.863, 0.996, 1)
	scrollFrame2:SetScrollChild(app.EditPanel.Pages[12].Events)

	app.EditPanel.Pages[12].Events:SetAutoFocus(false)
	app.EditPanel.Pages[12].Events:SetScript("OnEscapePressed", function(self)
		self:SetText(app:MakeCsvString(app.FlagsList.Selected.events or ""))
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].Events:SetScript("OnEditFocusLost", function(self)
	...
	local string5 = app.EditPanel.Pages[12]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	scrollFrame3:SetScript("OnMouseDown", function()
		app.EditPanel.Pages[12].Description:SetFocus()
	end)
	...
	app.EditPanel.Pages[12].Description = CreateFrame("EditBox", nil, scrollFrame3)
	app.EditPanel.Pages[12].Description:SetFontObject(GameFontNormalMed1)
	app.EditPanel.Pages[12].Description:SetTextColor(1, 1, 1)
	app.EditPanel.Pages[12].Description:SetWidth(scrollFrame3:GetWidth())
	app.EditPanel.Pages[12].Description:SetPoint("TOPLEFT")
	app.EditPanel.Pages[12].Description:SetMultiLine(true)
	scrollFrame3:SetScrollChild(app.EditPanel.Pages[12].Description)

	app.EditPanel.Pages[12].Description:SetAutoFocus(false)
	app.EditPanel.Pages[12].Description:SetScript("OnEscapePressed", function(self)
		self:SetText(app.FlagsList.Selected.description or "")
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].Description:SetScript("OnEditFocusGained", function(self)
		self:HighlightText(0, 0)
	end)
	app.EditPanel.Pages[12].Description:SetScript("OnEditFocusLost", function(self)
		app.FlagsList.Selected.description = self:GetText()
		C_Timer.After(0.1, function() app:UpdateStatusList() end)
	end)

	local string6 = app.EditPanel.Pages[12]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	app.EditPanel.Pages[12].URL = CreateFrame("EditBox", nil, backdrop6)
	app.EditPanel.Pages[12].URL:SetFontObject(GameFontNormalMed1)
	app.EditPanel.Pages[12].URL:SetTextColor(1, 1, 1)
	app.EditPanel.Pages[12].URL:SetSize(backdrop6:GetWidth()-6, backdrop6:GetHeight())
	app.EditPanel.Pages[12].URL:SetPoint("TOPLEFT", backdrop6, 6, 0)
	app.EditPanel.Pages[12].URL:SetAutoFocus(false)
	app.EditPanel.Pages[12].URL:SetScript("OnEditFocusGained", function(self)
		self:HighlightText(0, 0)
	end)
	app.EditPanel.Pages[12].URL:SetScript("OnEnterPressed", function(self)
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].URL:SetScript("OnEscapePressed", function(self)
		self:SetText(app.FlagsList.Selected.url or "")
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].URL:SetScript("OnEditFocusLost", function(self)
		app.FlagsList.Selected.url = self:GetText()
		C_Timer.After(0.1, function() app:UpdateStatusList() end)
	end)

	local string7 = app.EditPanel.Pages[12]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
	...
	app.EditPanel.Pages[12].Version = CreateFrame("EditBox", nil, backdrop7)
	app.EditPanel.Pages[12].Version:SetFontObject(GameFontNormalMed1)
	app.EditPanel.Pages[12].Version:SetTextColor(1, 1, 1)
	app.EditPanel.Pages[12].Version:SetSize(backdrop7:GetWidth()-6, backdrop7:GetHeight())
	app.EditPanel.Pages[12].Version:SetPoint("TOPLEFT", backdrop7, 6, 0)
	app.EditPanel.Pages[12].Version:SetAutoFocus(false)
	app.EditPanel.Pages[12].Version:SetScript("OnEditFocusGained", function(self)
		self:HighlightText(0, 0)
	end)
	app.EditPanel.Pages[12].Version:SetScript("OnEnterPressed", function(self)
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].Version:SetScript("OnEscapePressed", function(self)
		self:SetText(app.FlagsList.Selected.semver or "")
		self:ClearFocus()
	end)
	app.EditPanel.Pages[12].Version:SetScript("OnEditFocusLost", function(self)
		app.FlagsList.Selected.semver = self:GetText()
		C_Timer.After(0.1, function() app:UpdateStatusList() end)
	end)
	...
	app.EditPanel.Pages[12].Templates = CreateFrame("DropdownButton", nil, app.EditPanel.Pages[12], "WowStyle1DropdownTemplate")
	app.EditPanel.Pages[12].Templates:SetWidth(100)
	app.EditPanel.Pages[12].Templates:SetPoint("TOPRIGHT", app.EditPanel.Pages[12], -10, -10)
	app.EditPanel.Pages[12].Templates:SetDefaultText(L.TEMPLATES)
	...
	MenuUtil.CreateButtonMenu(app.EditPanel.Pages[12].Templates, unpack(templates))
	...
	string1:SetText("W.I.P. Can't do this for a group yet, but you can set this per flag.")
	...
	string1:SetText(L.HIDE_AFTER)
	string1:SetPoint("TOPLEFT", app.EditPanel.Pages[32], 10, -12)
	...
	app.EditPanel.Pages[32].HideAfter = CreateFrame("EditBox", nil, backdrop1)
	app.EditPanel.Pages[32].HideAfter:SetFontObject(GameFontNormalMed1)
	app.EditPanel.Pages[32].HideAfter:SetTextColor(1, 1, 1)
	app.EditPanel.Pages[32].HideAfter:SetSize(backdrop1:GetWidth()-6, backdrop1:GetHeight())
	app.EditPanel.Pages[32].HideAfter:SetPoint("TOPLEFT", backdrop1, 6, 0)
	app.EditPanel.Pages[32].HideAfter:SetAutoFocus(false)
	app.EditPanel.Pages[32].HideAfter:SetScript("OnEditFocusGained", function(self)
		self:HighlightText(0, 0)
	end)
	app.EditPanel.Pages[32].HideAfter:SetScript("OnEnterPressed", function(self)
		self:ClearFocus()
	end)
	app.EditPanel.Pages[32].HideAfter:SetScript("OnEscapePressed", function(self)
		self:SetText(app.FlagsList.Selected.actions.hideAfter or 0)
		self:ClearFocus()
	end)
	app.EditPanel.Pages[32].HideAfter:SetScript("OnEditFocusLost", function(self)
		app.FlagsList.Selected.actions.hideAfter = tonumber(self:GetText()) or 0
		C_Timer.After(0.1, function() app:UpdateStatusList() end)
	end)
	...
	app.EditPanel:SetFlattensRenderLayers(true)
	app.CodeBox:SetFlattensRenderLayers(true)
...
function app:SetSelected()
	...
	-- Pages
	for i, _ in pairs(app.EditPanel.Pages) do
		app.EditPanel.Pages[i]:Hide()
	end

	if app.FlagsList.SelGroup == 1 and app.FlagsList.SelFlag == 0 then
		app.EditPanel.Pages[10]:Show()
		app.SelectedTab = 1
		PanelTemplates_SetTab(app.EditPanel.Options, 1)
		PanelTemplates_DisableTab(app.EditPanel.Options, 2)
		PanelTemplates_DisableTab(app.EditPanel.Options, 3)
	else
		--PanelTemplates_EnableTab(app.EditPanel.Options, 2)
		PanelTemplates_EnableTab(app.EditPanel.Options, 3)

		if app.SelectedTab == 1 then
			if not app.FlagsList.Selected.icon then
				app.EditPanel.Pages[11]:Show()

				app.EditPanel.Pages[11].Title:SetText(app.FlagsList.Selected.title or "")
				app.EditPanel.Pages[11].Style:OverrideText(L.GROUP_STYLE[app.FlagsList.Selected.style])
				app.EditPanel.Pages[11].Anchor:OverrideText(L.GROUP_ANCHOR[app.FlagsList.Selected.anchor])
				app.EditPanel.Pages[11].Font:OverrideText(app.FlagsList.Selected.font)
				app.EditPanel.Pages[11].Scale:SetValue(app.FlagsList.Selected.scale)

				for _, font in ipairs(app.Fonts) do
					if font.name == app.FlagsList.Selected.font then
						app.EditPanel.Pages[11].Font.Text:SetFont(font.path, 13, "")
						break
					end
				end
			else
				app.EditPanel.Pages[12]:Show()

				app.EditPanel.Pages[12].Title:SetText(app.FlagsList.Selected.title or "")
				app.EditPanel.Pages[12].Icon:SetText(app.FlagsList.Selected.icon or "")
		...
		elseif app.SelectedTab == 2 then
			if not app.FlagsList.Selected.icon then
				app.EditPanel.Pages[21]:Show()
			else
				app.EditPanel.Pages[22]:Show()
			end
		elseif app.SelectedTab == 3 then
			if not app.FlagsList.Selected.icon then
				app.EditPanel.Pages[31]:Show()
			else
				app.EditPanel.Pages[32]:Show()

				app.EditPanel.Pages[32].HideAfter:SetText(app.FlagsList.Selected.actions.hideAfter or 0)
			end
		end
	end
end
